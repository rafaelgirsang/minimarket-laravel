...
$keterangan['type']       = 0;//text
$keterangan['content']    = 'keterangan:';//any string    
$keterangan['bold']       = 0;//0 if no, 1 if yes
$keterangan['align']      =0;//0 if left, 1 if center, 2 if right
$keterangan['format']     = 0;//0 if normal, 1 if double Height, 2 if double Height + Width, 3 if double Width, 4 if small
array_push($a,$keterangan);

$ket1['type']       = 0;//text
$ket1['content']    = '- Laundry bisa diambil sesuai deadline';//any string    
$ket1['bold']       = 0;//0 if no, 1 if yes
$ket1['align']      =0;//0 if left, 1 if center, 2 if right
$ket1['format']     = 4;//0 if normal, 1 if double Height, 2 if double Height + Width, 3 if double Width, 4 if small
array_push($a,$ket1);
$ket2['type']       = 0;//text
$ket2['content']    = '- Pengambilan laundry harap disertai nota';//any string    
$ket2['bold']       = 0;//0 if no, 1 if yes
$ket2['align']      =0;//0 if left, 1 if center, 2 if right
$ket2['format']     = 4;//0 if normal, 1 if double Height, 2 if double Height + Width, 3 if double Width, 4 if small
array_push($a,$ket2);
$ket3['type']       = 0;//text
$ket3['content']    = '- Komplain 1x24 jam setelah laundry diambil';//any string    
$ket3['bold']       = 0;//0 if no, 1 if yes
$ket3['align']      =0;//0 if left, 1 if center, 2 if right
$ket3['format']     = 4;//0 if normal, 1 if double Height, 2 if double Height + Width, 3 if double Width, 4 if small
array_push($a,$ket3);



$thank['type']       = 0;//text
$thank['content']    = '- Terimakasih -';//any string    
$thank['bold']       = 0;//0 if no, 1 if yes
$thank['align']      =1;//0 if left, 1 if center, 2 if right
$thank['format']     = 4;//0 if normal, 1 if double Height, 2 if double Height + Width, 3 if double Width, 4 if small
array_push($a,$thank);
