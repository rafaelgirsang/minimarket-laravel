    ...
    <div class="card  shadow-sm">
        <form action="{{ url('penjualan') }}" method="post">
                ...
                <div class="accordion accordion-icon-collapse" id="kt_accordion_3">
                    ...
                    <div class="mb-1">
                        ...
                        <div class="accordion-header py-3 d-flex" data-bs-toggle="collapse"
                            ...
                            <h3 class="fs-4 fw-semibold mb-0 ms-4">Data Customer</h3>
                        </div>
                        <!--end::Header-->
                    ...
                    <div class="mb-1">
                        ...
                        <div class="accordion-header py-3 d-flex " data-bs-toggle="collapse"
                            ...
                            <h3 class="fs-4 fw-semibold mb-0 ms-4">Layanan</h3>
                        </div>
                        <!--end::Header-->

                        <!--begin::Body-->
                        <div id="kt_accordion_3_item_2" class="collapse show fs-6 ps-10" data-bs-parent="#kt_accordion_3">
                            <!--begin::Repeater-->
                            <div id="layanan">
                                    ...
                                    <div data-repeater-list="kt_docs_repeater_basic">
                                        <div data-repeater-item>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-2">
                                                    <label for="basic-url" class="form-label">Deadline (jam)</label>
                                                    <div class="input-group input-group-sm  mb-5">
                                                        <input type="text"
                                                ...
                                                <div class="col-md-2">
                                                    <label for="basic-url" class="form-label">Berat/Jumlah</label>
                                                    <div class="input-group input-group-sm  mb-5">
                                                        <input type="number"
                    ...
                    <div class="mb-1">
                        ...
                        <div class="accordion-header py-3 d-flex " data-bs-toggle="collapse"
                            ...
                            <h3 class="fs-4 fw-semibold mb-0 ms-4">Payment</h3>
                        </div>
                        <!--end::Header-->

                        <!--begin::Body-->
                        <div id="kt_accordion_3_item_3" class="collapse show fs-6 ps-10"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 jenis-pembayaran">
                                    ...
                                    <div class="input-group input-group-sm  mb-5">
                                        <select class="form-select jenis @error('jenis') is-invalid @enderror"
            ...
            <div class="d-flex card-footer card-footer-form" style="justify-content: space-between">
                ...
                <a href="{{ url('penjualan') }}" class="btn  btn-primary btn-sm hover-scale">
                    Back
                </a>
