                                ...
                                @if (!empty(checkData($data)))
                                    ...
                                    @foreach ($data as $row)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ url('supplier/produk/' . crypt_make($row->id)) }}"
                                                    class="btn btn-primary btn-sm">Produk</a>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a
                                                            href="{{ url('supplier/edit/' . crypt_make($row->id)) }}"class="menu-link px-3 update">Edit</a>
                                                    </div>
                                                    <div class="menu-item px-3">
                                                        <a
                                                            href="{{ url('supplier/produk/' . crypt_make($row->id)) }}"class="menu-link px-3 update">Produk</a>
                                                    </div>
                                                    {{-- <form action="{{ url('supplier/' . crypt_make($row->id)) }}"
