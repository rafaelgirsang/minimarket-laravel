...
@section('content')
    <div class="card shadow-sm">
        <div class="card-header card-header-costum">
            ...
            <div class="card-toolbar">
                <a href="{{ url('user/create') }}" class="btn btn-sm btn-primary  hover-scale" data-bs-toggle="modal"
                                ...
                                @if (!empty(checkData($data)))
                                    ...
                                    @foreach ($data as $row)
                                        <tr>
                                            ...
                                            <td> <a href="{{ url('produkKateori/produk/' . crypt_make($row->id)) }}"
                                            ...
                                            <td>
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                    ...
                                                    {{-- <form action="{{ url('produkKategori/' . crypt_make($row->id)) }}"
    ...
    <div class="modal fade" tabindex="-1" id="update">
        <form action="{{ url('produkKategoriUpdate') }}" method="POST">
            @csrf
