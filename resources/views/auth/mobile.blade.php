        ...
        <div class="d-flex flex-column flex-column-fluid flex-lg-row">
            ...
            <div class="d-flex flex-center w-lg-50 pt-15 pt-lg-0 px-10">
                ...
                {{-- <div class="d-flex flex-center flex-lg-start flex-column">
                    <!--begin::Logo-->
                    <a href="#" class="mb-0">
                        <h1 class="text-white" style="font-size: 23px;">Purple Bubbles Laundry</h1>
                    </a>
                    <!--end::Logo-->
                    <!--begin::Title-->
                    <h2 class="text-white fw-normal m-0 fs-6">Smart loundy for your precious clothes</h2>
                    <!--end::Title-->
                </div> --}}
                <!--begin::Aside-->
            </div>
            <!--begin::Aside-->
            <!--begin::Body-->
            <div class="flex-lg-row-auto justify-content-center justify-content-lg-end p-5 p-lg-20">
                <!--begin::Card-->
                    ...
                    <div class="d-flex flex-center flex-column flex-column-fluid px-lg-10 pb-15 pb-lg-20">
                        ...
                        <form class="form w-100" novalidate="novalidate" action="{{ route('authenticate') }}"
                            ...
                            <div class="text-center mb-3">
                                ...
                                <!--end::Title-->
                                <!--begin::Subtitle-->
                                <div class="text-gray-500 fw-semibold fs-6">Your Management App</div>
                                <!--end::Subtitle=-->
                            </div>
                            <!--begin::Heading-->
                            <!--begin::Login options-->
                    ...
                    <div class="d-flex flex-center ">
                        ...
                        <div class="row">
                            <div class="col-md-12 align-items-center text-center">
                                <div class="d-flex  text-gray-500 fs-base gap-5">
