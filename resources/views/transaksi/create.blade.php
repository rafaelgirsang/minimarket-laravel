                    ...
                    <div class="card  shadow-sm">
                        <div class="card-body ">
                            <div class="d-flex flex-stack bg-success rounded-3 p-6"
                                style="background-color: #b874f1 !important; color:black !important">
                                <!--begin::Content-->
                                <div class="fs-7 fw-bold text-white">
                                    <span
                                        style="font-size: 16px !important; color:black !important; font-weight:bold !important"
                                        class="d-block lh-1 mb-2">Jumlah Item</span>
                                    <span
                                        style="font-size: 16px !important; color:black !important; font-weight:bold !important"
                                        class="d-block mb-2">Subtotal</span>
                                    <span
                                        style="font-size: 16px !important; color:black !important; font-weight:bold !important"
                                        class="d-block mb-9">Diskon</span>
                                    <span class="d-block fs-2qx lh-1"
                                        style=" color:black !important; font-weight:bold !important">Total</span>
                                </div>
                                <!--end::Content-->
                                ...
                                <div class="fs-7 fw-bold text-white text-end">
                                    <span
                                        style="font-size: 16px !important;  color:black !important; font-weight:bold !important"
                                        class="d-block lh-1 mb-2" data-kt-pos-element="total">{{ $jumlahItem }} </span>
                                    <span
                                        style="font-size: 16px !important;  color:black !important; font-weight:bold !important"
                                        class="d-block mb-2" data-kt-pos-element="total">{{ money($subtotal) }}</span>
                                    <div id="hide-diskon">
                                        <span
                                            style="font-size: 16px !important;  color:black !important; font-weight:bold !important"
                                            class="d-block mb-9" data-kt-pos-element="discount" id="hide-diskon">0</span>
                                    </div>

                                    <div style="font-size: 16px !important;  color:black !important; font-weight:bold !important"
                                        id="show-diskon"></div>


                                    <div id="hide-total" style=" color:black !important; font-weight:bold !important">
                                        <span class="d-block fs-2qx lh-1"
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group input-group-sm  mb-5">
                                            <input type="number" class="form-control input-diskon" id="diskon"
                                                placeholder="0" name="diskon" value="" {{ $disabled }}
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group input-group-sm  mb-5">
                                            <input type="number" class="form-control input-pembayaran" id="pembayaran"
                                                placeholder="0" name="pembayaran" value="" {{ $disabled }}
                                                style="color: black !important; font-weight:bold">
