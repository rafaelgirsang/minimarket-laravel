...
<div class="row">
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="input-group input-group-sm  mb-5">
                                <input type="text" class="form-control input-barcode" id="barcode" name="barcode" value="" autofocus>
                        ...
                        <div class="col-6">
                            ...
                            <div class="input-group input-group-sm  mb-5">
                                <select class="form-select form-select-sm pilih-produk" data-control="select2" data-placeholder="Pilih produk" name="produk">
                                    <option></option>
                        ...
                        <div class="table-responsive" style="min-height: 260px">
                            <table class="table table-striped table-bordered table-hover border rounded w-100 text-center" sty>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $no++ }}</td>
                                        <td class="text-start">{{ $row->produk }} <span style="font-style: italic; color:grey; font-size:12px">(Stok :
                                        ...
                                        <td>
                                            <div class="row" style="--bs-gutter-x: 0rem">
                                                <div class="col-6 text-center">
                                                    <a href="#" data-bs-toggle="modal" data-bs-target="#updateItemTemp{{ $row->id }}">
                                                        <i class="bi bi-pencil-square text-success">
                                                        </i>
                                                    </a>
                                                </div>
                                                <div class="col-6 text-center">
                                                    <form action="{{ url('transaksi/deleteItem/' . crypt_make($row->id)) }}" method="post" id="form-delete-{{ $row->id }}">

                                                        @csrf
                                                        @method('DELETE')
                                                        <a href="#" onclick="destroy({{ $row->id }})" class="menu-link px-3"><i class="bi bi-trash text-danger">
                                                            </i>
                                                        </a>
    ...
    <div class="col-md-4">
                    ...
                    <div class="card-body ">
                        <div class="d-flex flex-stack bg-success rounded-3 p-6">
                            ...
                            <div class="fs-7 fw-bold text-white text-end">
                                ...
                                <span class="d-block mb-9" data-kt-pos-element="discount">0</span>
                                <span class="d-block fs-2qx lh-1" data-kt-pos-element="grant-total">{{ money($subtotal) }}</span>
                            </div>
                            <!--end::Content-->
                        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card  shadow-sm">
                    <form action="{{ url('transaksi/save') }}" method="get">
                        <div class="card-body ">
                            <div class="row">
                                <div class="col-12">
                                    <label for="basic-url" class="form-label">Metode Pembayaran</label>
                                    <div class="input-group input-group-sm  mb-5">
                                        <select type="number" class="form-control pilih-metode-pembayaran" name="metode_id" required>
                                            <option value="">Pilih</option>
                                            @foreach ($metode as $rowMetode)
                                            <option value="{{ $rowMetode->id }}" {{ selected($rowMetode->id, $metodeId) }}>{{ $rowMetode->metode }}
                                            </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="input-group input-group-sm  mb-5">
                                        <input type="number" class="form-control input-pembayaran" id="pembayaran" name="pembayaran" value="">
                                        @error('barcode')
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 text-end">
                                    @if ($exist && $pembayaran)
                                    {{-- <a href="{{ url('transaksi/save/') }}" class="btn btn-success btn-sm">
                                    Save
                                    </a> --}}
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <label for="basic-url" class="form-label">Produk</label>
                                <div class="input-group input-group-sm  mb-5">
                                    <input type="text" class="form-control" name="produk" value="{{ $row->produk }}" readonly>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <div class="input-group input-group-sm  mb-5">
                                    <input type="number" class="form-control " name="jumlah" min="0" max="{{ getStokByProdukId($row->produk_id) }}" value="{{ $row->jumlah }}" required>
                                    @php
                                    $stokTersediaEdit = getStokByProdukId($row->produk_id) - $row->jumlah;
                                    @endphp
                                    @if ($stokTersediaEdit >= 1)
                                    <div class="invalid-feedback" style="display: block; margin-top:0.3rem; font-style:italic; color:green">
                                        Stok tersedia {{ $stokTersediaEdit }}
                                    </div>
                                    @else
                                    <div class="invalid-feedback" style="display: block; margin-top:0.3rem; font-style:italic; color:red">
                    ...
                    <div class="modal-footer" style="padding-top: 5px; padding-bottom:5px; justify-content:space-between">
                        <button type="button" class="btn btn-light btn-sm  hover-scale" data-bs-dismiss="modal">Close</button>
    ...
    <script>
        $('.pilih-produk').on('change', function() {
            ...
            $.ajax({
                type: "get",
                url: "createTempByBarcode/" + barcode,
                dataType: "json",
                success: function(response) {
                    window.location.reload();
                }
